...
**Current World Leader (Fastest Verified):** 970,874 numbers checked per second – **@A.Cüneyt Çakanlı** (NVIDIA GeForce RTX 3070)

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
| 1    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-01-28 20:00 | NVIDIA GeForce RTX 3070 | %83             | 1,224           | 5               | 0.103           |
