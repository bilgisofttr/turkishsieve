...
**Current World Leader (Fastest Verified):** 100,000,000 numbers checked per second – **@Umut Öner** (12th Gen Intel(R) Core(TM) i7-12700)

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                             | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|-------------------------------------|--------|---------------|------|--------------|
| 1    | Umut Öner       | umutoner46@yahoo.com | 2026-01-26 12:39 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 1,216           | 5               | 0.001           |
| 2    | Server1         | bilgisoft.tr@gmail.com | 2026-02-04 04:08 | Intel(R) Xeon(R) CPU E7-4860 v2 @ 2.60GHz | -               | 1,216           | 5               | 0.001           |
| 3    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-01-28 20:08 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 1,216           | 5               | 0.030           |
