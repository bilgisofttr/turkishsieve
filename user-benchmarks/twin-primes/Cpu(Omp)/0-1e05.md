...
**Current World Leader (Fastest Verified):** 100,000,000 numbers checked per second – **@Server1** (Intel(R) Xeon(R) CPU E7-4860 v2 @ 2.60GHz)

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                             | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|-------------------------------------|--------|---------------|------|--------------|
| 1    | Server1         | bilgisoft.tr@gmail.com | 2026-02-04 04:05 | Intel(R) Xeon(R) CPU E7-4860 v2 @ 2.60GHz | -               | 1,224           | 5               | 0.001           |
| 2    | Umut Öner       | umutoner46@yahoo.com | 2026-01-26 12:36 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 1,244           | 5               | 0.003           |
| 3    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-01-28 20:03 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 1,224           | 5               | 0.014           |
