...
**Current World Leader (Fastest Verified):** 33,670,033,670 numbers checked per second – **@Hüseyin Çakanlı** (12th Gen Intel(R) Core(TM) i7-12700).

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU                        | Occup. | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
