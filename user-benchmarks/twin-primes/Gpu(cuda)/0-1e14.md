...
**Current World Leader (Fastest Verified):** 278,287,197,954 numbers checked per second – **@EBB_Server** (NVIDIA GeForce RTX 5090)

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
| 1    | EBB_Server      | serkancekic@msn.com | 2026-01-30 11:01 | NVIDIA GeForce RTX 5090 | %83             | 135,780,321,665 | 5               | 359.341         |
