...
**Current World Leader (Fastest Verified):** 6,250 numbers checked per second – **@A.Cüneyt Çakanlı** (12th Gen Intel(R) Core(TM) i7-12700)

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                             | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|-------------------------------------|--------|---------------|------|--------------|
| 1    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-01-28 20:02 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 8               | 5               | 0.016           |
