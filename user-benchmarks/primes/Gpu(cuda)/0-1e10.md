...
**Current World Leader (Fastest Verified):** 70,422,535,211 numbers checked per second – **@Hüseyin Çakanlı** (NVIDIA GeForce GTX 1650 Ti).

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
| 1    | Hüseyin Çakanlı       | bilgisoft.tr@gmail.com         | 2026-01-28 14:27  | NVIDIA GeForce GTX 1650 Ti | %100   | 455,052,511   | 5    | 0.142        |
