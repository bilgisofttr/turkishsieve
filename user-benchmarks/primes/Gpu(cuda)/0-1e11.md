...
**Current World Leader (Fastest Verified):** 58,548,009,368 numbers checked per second – **@Hüseyin Çakanlı** (NVIDIA GeForce GTX 1650 Ti).

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
| 1    | Hüseyin Çakanlı       | bilgisoft.tr@gmail.com         | 2026-01-26 14:18  | NVIDIA GeForce GTX 1650 Ti | %100   | 4,118,054,813 | 5    | 1.708        |
