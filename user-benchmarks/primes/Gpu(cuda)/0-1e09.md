...
**Current World Leader (Fastest Verified):** 7,936,507,937 numbers checked per second – **@A.Cüneyt Çakanlı** (NVIDIA GeForce RTX 3070)

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
| 1    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-01-28 19:52 | NVIDIA GeForce RTX 3070 | %83             | 50,847,534      | 5               | 0.126           |
