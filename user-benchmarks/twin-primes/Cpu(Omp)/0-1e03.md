...
**Current World Leader (Fastest Verified):** 333,333 numbers checked per second – **@Umut Öner** (12th Gen Intel(R) Core(TM) i7-12700)

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                             | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|-------------------------------------|--------|---------------|------|--------------|
| 1    | Umut Öner       | umutoner46@yahoo.com | 2026-01-26 12:36 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 35              | 5               | 0.003           |
| 2    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-02-01 19:26 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 35              | 5               | 0.033           |
