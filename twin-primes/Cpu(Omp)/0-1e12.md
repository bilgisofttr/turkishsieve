...
**Current World Leader (Fastest Verified):** 14,781,529,001 numbers checked per second – **@Umut Öner** (12th Gen Intel(R) Core(TM) i7-12700)

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                             | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|--------------------------------------|--------|---------------|------|--------------|
| 1 | Umut Öner | umutoner46@yahoo.com | 2026-01-26 12:39 | 12th Gen Intel(R) Core(TM) i7-12700 | N/A | 1,870,585,220 | 5 | 67.652 |
