...
**Current World Leader (Fastest Verified):** 8,123,747,420 numbers checked per second – **@A.Cüneyt Çakanlı** (12th Gen Intel(R) Core(TM) i7-12700)

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                             | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|-------------------------------------|--------|---------------|------|--------------|
| 1    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-01-28 20:31 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 15,834,656,003  | 5               | 1230.959        |
