...
**Current World Leader (Fastest Verified):** 140,605,249,356 numbers checked per second – **@EBB_Server** (NVIDIA GeForce RTX 5090)

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
| 1    | EBB_Server      | serkancekic@msn.com | 2026-01-30 10:52 | NVIDIA GeForce RTX 5090 | %83             | 3,204,941,750,802 | 5               | 711.211         |
