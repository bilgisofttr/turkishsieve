...
**Current World Leader (Fastest Verified):** 243,605,359,318 numbers checked per second – **@A.Cüneyt Çakanlı** (NVIDIA GeForce RTX 3070)

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
| 1    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-01-28 20:01 | NVIDIA GeForce RTX 3070 | %83             | 1,870,585,220   | 5               | 4.105           |
