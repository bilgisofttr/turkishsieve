...
**Current World Leader (Fastest Verified):** 7,462,686,567 numbers checked per second – **@Hüseyin Çakanlı** (12th Gen Intel(R) Core(TM) i7-12700).

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                            | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|-------------------------------------|--------|---------------|------|--------------|
| 1    | Hüseyin Çakanlı       | bilgisoft.tr@gmail.com         | 2026-01-26 14:12  | Intel(R) Core(TM) i7-10750H 2.60GHz | 11/12  | 50,847,534    | 5    | 0.134        |
