...
**Current World Leader (Fastest Verified):** 25,634,452,704 numbers checked per second – **@Umut Öner** (12th Gen Intel(R) Core(TM) i7-12700)

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                             | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|--------------------------------------|--------|---------------|------|--------------|
| 1 | Umut Öner | umutoner46@yahoo.com | 2026-01-26 12:41 | 12th Gen Intel(R) Core(TM) i7-12700 | N/A | 224,373,161 | 5 | 3.901 |
