...
**Current World Leader (Fastest Verified):** 14,994,506,762 numbers checked per second – **@A.Cüneyt Çakanlı** (12th Gen Intel(R) Core(TM) i7-12700).

| Rank | User Name (Nick)      | Email                          | Date-Time               | Hardware                          | Count (Pairs)   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------------|---------------------------------------|-----------------|------|--------------|
| 1    | A.Cüneyt Çakanlı      | acakanli@hotmail.com           | 2026-01-17 13:15        | 12th Gen Intel(R) Core(TM) i7-12700   | 135,780,321,665 | 5    | 6669.109     |
