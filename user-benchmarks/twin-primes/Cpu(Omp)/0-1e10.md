...
**Current World Leader (Fastest Verified):** 34,013,605,442 numbers checked per second – **@A.Cüneyt Çakanlı** (12th Gen Intel(R) Core(TM) i7-12700)

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                             | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|-------------------------------------|--------|---------------|------|--------------|
| 1    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-01-28 20:03 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 27,412,679      | 5               | 0.294           |
| 2    | Umut Öner       | umutoner46@yahoo.com | 2026-01-26 12:37 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 27,412,679      | 5               | 0.295           |
