...
**Current World Leader (Fastest Verified):** 2,500,000,000 numbers checked per second – **@Umut Öner** (12th Gen Intel(R) Core(TM) i7-12700)

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                             | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|-------------------------------------|--------|---------------|------|--------------|
| 1    | Umut Öner       | umutoner46@yahoo.com | 2026-01-26 12:40 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 58,622          | 5               | 0.004           |
| 2    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-01-28 20:08 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 58,622          | 5               | 0.029           |
