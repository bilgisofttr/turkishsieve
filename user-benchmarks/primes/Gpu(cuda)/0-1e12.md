...
**Current World Leader (Fastest Verified):** 41,724,037,218 numbers checked per second – **@Hüseyin Çakanlı** (NVIDIA GeForce GTX 1650 Ti).

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. |  Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|----------------|------|--------------|
| 1    | Hüseyin Çakanlı       | bilgisoft.tr@gmail.com         | 2026-01-28 14:04  | NVIDIA GeForce GTX 1650 Ti | %100   | 37,607,912,018 | 5    | 23.967       |
