...
**Current World Leader (Fastest Verified):** 7,462,686,567 numbers checked per second – **@Hüseyin Çakanlı** (NVIDIA GeForce GTX 1650 Ti).

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
| 1    | Hüseyin Çakanlı       | bilgisoft.tr@gmail.com         | 2026-01-26 14:12  | NVIDIA GeForce GTX 1650 Ti | %100   | 50,847,534    | 5    | 0.134        |
