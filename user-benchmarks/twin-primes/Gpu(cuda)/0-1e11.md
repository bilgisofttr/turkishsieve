...
**Current World Leader (Fastest Verified):** 75,757,575,758 numbers checked per second – **@Hüseyin Çakanlı** (NVIDIA GeForce GTX 1650 Ti)

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
| 1    | Hüseyin Çakanlı | bilgisoft.tr@gmail.com | 2026-01-28 07:45 | NVIDIA GeForce GTX 1650 Ti | %100            | 224,376,048     | 5               | 1.320           |
