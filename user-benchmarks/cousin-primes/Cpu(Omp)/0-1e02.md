...
**Current World Leader (Fastest Verified):** 100,000 numbers checked per second – **@Hakan Halis** (AMD Ryzen 5 5600X 6-Core Processor)

| Rank | User Name (Nick)      | Email                          | Date-Time         | Hardware                             | Thread | Count (Pairs) | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|-------------------------------------|--------|---------------|------|--------------|
| 1    | Hakan Halis     | hakanhalis@hotmail.com | 2026-01-31 15:04 | AMD Ryzen 5 5600X 6-Core Processor | -               | 8               | 5               | 0.001           |
| 2    | Server1         | bilgisoft.tr@gmail.com | 2026-02-04 04:08 | Intel(R) Xeon(R) CPU E7-4860 v2 @ 2.60GHz | -               | 8               | 5               | 0.007           |
| 3    | A.Cüneyt Çakanlı | acakanli@hotmail.com | 2026-02-01 19:39 | 12th Gen Intel(R) Core(TM) i7-12700 | -               | 8               | 5               | 0.012           |
