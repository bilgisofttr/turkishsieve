...
**Current World Leader (Fastest Verified):** 71,942,446,043 numbers checked per second – **@Hüseyin Çakanlı** (NVIDIA GeForce GTX 1650 Ti)

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Cousin Count | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|-----------------|------|--------------|
| 1 | Hüseyin Çakanlı | bilgisoft.tr@gmail.com | 2026-01-27 16:27 | NVIDIA GeForce GTX 1650 Ti | %100 | 224,373,161 | 5 | 1.390 |
