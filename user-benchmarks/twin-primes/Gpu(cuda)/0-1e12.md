...
**Current World Leader (Fastest Verified):** 59,837,242,700 numbers checked per second – **@Hüseyin Çakanlı** (NVIDIA GeForce GTX 1650 Ti)

| Rank | User Name (Nick)      | Email                          | Date-Time         | GPU Hardware               | Occup. | Prime Count   | Runs | Avg. Time(s) |
|------|-----------------------|--------------------------------|-------------------|----------------------------|--------|---------------|------|--------------|
| 1    | Hüseyin Çakanlı | bilgisoft.tr@gmail.com | 2026-01-28 12:43 | NVIDIA GeForce GTX 1650 Ti | %100            | 1,870,585,220   | 5               | 16.712          |
